...
INSERT INTO `baked_good` VALUES (1,'Cinnamon Roll','A coffee shop classic. A sweet flakey roll with our patented cinnamon icing. Simply melts in your mouth.',1.75,'/static/bakery/CinnamonRoll.jpg'),(2,'Danish','A flakey pastry with fresh, sweet fruits baked in. A great way to start your day.',2.00,'/static/bakery/Danish.jpg'),(3,'Croissant','Like a danish, but skip the fruits. Great for someone on the go.',1.50,'/static/bakery/Croissant.jpg'),(4,'Fresh Muffin','Our delectable muffins are always warm and fresh. Comes in Plain, Blueberry, Banana Nut, or Triple Chocolate.',1.10,'/static/bakery/Muffin.jpg'),(5,'Fresh Cookie','Baked fresh every day, you can\'t go wrong. Comes in Sugar, Snickerdoodle, Chocolate chip, and Oatmeal.',0.85,'/static/bakery/Cookie.jpg'),(6,'Scone','Similar to our muffins, but lighter and softer.',1.10,'/static/bakery/Scone.jpg'),(7,'Biscotti','Italian almond buscuits, twice-baked for a delightfully crunchy texture.',1.25,'/static/bakery/Biscotti.jpg');
...
INSERT INTO `coffee` VALUES (1,'Espresso','A small shot of caffeine, but more than enough to get the job done.',3.45,'/static/coffee/Espresso.jpg'),(2,'Macchiato','A shot of caffeine with a heavenly touch of foamed milk.',3.60,'/static/coffee/Macchiato.jpg'),(3,'Latte','Some espresso mixed with rich steamed milk and a dallop of foamed milk.',3.75,'/static/coffee/Latte.jpg'),(4,'Mocha','Our patented blend of espresso, chocolate, and milk. Prefect if you want something sweet.',3.75,'/static/coffee/Mocha.jpg'),(5,'Cappuccino','Equal parts espresso, foamed milk, and steamed milk.',3.65,'/static/coffee/Cappuccino.jpg'),(6,'Americano','Like espresso, but with double the standard amount of water. Perfect if you want something that lasts.',3.00,'/static/coffee/Americano.jpg'),(7,'Ristretto','A concentrated shot of espresso. Straight and to the point.',3.00,'/static/coffee/Ristretto.jpg'),(8,'Doppio','An espresso with double the caffeine. Great for those extra early mornings.',3.75,'/static/coffee/Doppio.jpg'),(9,'Cafe Au Lait','For those that just want straight coffee with milk. No espresso. No complications.',2.50,'/static/coffee/CafeAuLait.jpg');
...
INSERT INTO `tea` VALUES (1,'Black Tea','Very powerful taste and kick, designed to kickstart your day like nothing else.',1.50,'/static/tea/Black.jpg'),(2,'Oolong Tea','As simple as they come, our Oolong tea is a reminder to sit back once in a while and let your mind relax.',2.50,'/static/tea/Oolong.jpg'),(3,'Jasmine Tea','Sweet and refreshing. Perfect to rejuvinate your mind body and mind throughout the day.',2.25,'/static/tea/Jasmine.jpg'),(4,'Peppermint Tea','Warm and powerful, this Peppermint is a true minty treat.',2.75,'/static/tea/Peppermint.jpg'),(5,'White Tea','Delicate and elegant, with hints of earthier elements, such as almonds.',1.50,'/static/tea/White.jpg'),(6,'Green Tea','Has a more \'vegative\' or \'leafy\' taste. Has many health benefits, and tastes great to boot.',2.50,'/static/tea/Green.jpg'),(7,'Earl Grey Tea','Smokey and fragrant, with hints of citrus. A subcategory of our fine black teas.',2.00,'/static/tea/EarlGrey.jpg');
...
-- Dump completed on 2016-11-21 21:24:43
